...
import { TOOLS } from "../_data/editor-tools";
import { EXPORT_FORMATS } from "../_data/editor-tools";
import {
  ArrowLeft,
  RotateCcw,
  RotateCw,
  ...
  useEffect(() => {
    ...
    const handleCanvasModified = () => {
      if (!isUndoRedoOperation) {
        //debouce state saving to avoid too many saves
        setTimeout(() => {
          if (!isUndoRedoOperation) {
            saveToUndoStack();
          }
    ...
    canvasEditor.on("object:created", handleCanvasModified);
